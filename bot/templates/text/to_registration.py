GET_PHONE_NUMBER = "Отлично!\nОстался последний шаг:\n\nНажми кнопку <b>«Поделиться моим контактом»</b>\n" \
                   "\U000023EC\U000023EC"\
                   "\n\n\n<i>Мой друг, не переживай, эта информация необходима только для наших HR. </i>"

FINISH_REGISTRATION = "Ура, мы справились! \n"

SEND_LINK = "Жми по кнопке и скорее становись частью нашего коммьюнити \U0001F609\n"
